...
(function () {
  ...
  function installStyles() {
    ...
    s.textContent = [
      ...
      '.__be-selected{outline:2px solid #0D1117 !important;outline-offset:-2px;box-shadow:0 0 0 9999px rgba(13,17,23,0.04) inset;}',
      '.__be-edit-text{outline:2px solid #0D1117 !important;outline-offset:-2px;}',
      '.__be-ui{position:absolute;z-index:2147483000;font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,sans-serif;}',
      '.__be-toolbar{display:flex;align-items:center;gap:3px;padding:6px;background:#1A1F24;border-radius:14px;box-shadow:0 12px 30px rgba(0,0,0,.32);}',
      ...
      '.__be-panel{width:280px;background:#fff;border:1px solid #ece6e2;border-radius:14px;box-shadow:0 18px 44px rgba(16,24,40,.2);overflow:hidden;color:#0D1117;}',
      '.__be-panel h4{margin:0;padding:13px 15px;font-size:14px;font-weight:600;border-bottom:1px solid #F1F2F5;display:flex;align-items:center;justify-content:space-between;}',
      ...
      '.__be-panel input[type=text],.__be-panel input[type=number],.__be-panel textarea,.__be-panel select{width:100%;box-sizing:border-box;border:1px solid #e5e0dc;border-radius:8px;padding:8px 10px;font-size:13px;color:#0D1117;background:#faf8f6;}',
      ...
      '.__be-seg button.__be-on{background:#F1F2F5;color:#0D1117;font-weight:600;}',
      '.__be-btn{all:unset;box-sizing:border-box;text-align:center;background:#0D1117;color:#fff;font-size:13px;font-weight:600;padding:9px 12px;border-radius:8px;cursor:pointer;}',
      '.__be-btn:hover{background:#1A1F24;}',
      '.__be-btn.__be-ghost{background:#f4f0ec;color:#3B424B;}',
      ...
      '.__be-hint{font-size:11px;color:#9CA3AF;line-height:1.4;}',
      '.__be-x{all:unset;cursor:pointer;color:#9CA3AF;display:grid;place-items:center;width:24px;height:24px;border-radius:6px;}',
      '.__be-x:hover{background:#f4f0ec;color:#3B424B;}',
      '.__be-donebar{display:flex;gap:8px;align-items:center;background:#1A1F24;color:#fff;padding:7px 9px 7px 13px;border-radius:12px;box-shadow:0 10px 28px rgba(0,0,0,.3);font-size:13px;}',
    ].join('');
